...
<!-- 
      <div class="nav-right">
        <span class="icon icon-one"><img src="./images/search.svg" alt=""></span>
        <span class="icon icon-two" ><img src="./images/user.svg" alt=""></span>
        <span class="icon icon-three"><img src="./images/heart.svg" alt=""></span>
        <span class="icon icon-four"><img src="./images/shopping-bag.svg" alt=""></span>
      </div> -->
<div class="nav-right">
...
<a href="wishlist.html" class="icon-btn" id="wishlistBtn" title="Wishlist">
